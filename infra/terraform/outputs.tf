...
output "runtime_secret_id_env_vars" {
  description = "Controller environment variable names mapped to deployment-managed OCI Vault secret OCIDs after the generated DB password exists and the manual secrets advance beyond their bootstrap versions."
  value = {
...
output "runtime_secret_ids" {
  description = "Deployment-managed Autographs runtime Vault secret OCIDs keyed by runtime secret name after the generated DB password exists and the manual secrets advance beyond their bootstrap versions."
  value = {
