...
Resume baseline: main advanced during the pause. Merge commit `e0a4c15` incorporates repository/deployment v0.1.8, active controller v0.1.4, and previous controller v0.1.3. Bootstrap version files now use 0.1.8; earlier plan references to the initial 0.1.3 and interim 0.1.5 baselines are historical.
