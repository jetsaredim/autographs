...
| Use Rust `oci_api` instance-principal auth for controller Object Storage access | The dev-node smoke proved OCI instance principal auth plus native Object Storage binary PUT/GET/DELETE against the private media bucket, avoiding S3 Customer Secret credentials, Python SDK drift, and hand-rolled runtime auth guesses | Phase 5 controller media adapter direction as of 2026-06-14 |
...
---
*Last updated: 2026-06-14 after confirming Rust `oci_api` instance-principal Object Storage direction*
