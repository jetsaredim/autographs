...
- Phase 8: Start with taxonomy/media exploration for optional product-line and set thumbnails, keeping text metadata canonical and any public derivatives small, optional, privacy/copyright reviewed, and independent from AI/OCR provider work.
...
- Phase 8 should look first at optional taxonomy/media cues for product-line and set values, which can use upcoming event items as practical test material without requiring OCR/AI provider work.
...
| 2026-07-19 | move-phase-8-ai-05-taxonomy-thumbnail-me | Moved Phase 8 taxonomy/media cue exploration to the first success criterion and renumbered the pending AI requirements so non-AI-specific product-line/set media work is looked at before OCR/AI ingest. |
