...
last_activity: 2026-09-03 -- Granted the OCI Database service name-scoped read access to the generated ADB password secret; tenancy apply and live rotation retry remain operator-owned.
progress:
  total_phases: 10
  completed_phases: 7
  total_plans: 47
...
Last activity: 2026-09-03 -- Granted the OCI Database service name-scoped read access to the generated ADB password secret; tenancy apply and live rotation retry remain operator-owned.
...
| Date | Task | Summary |
|------|------|---------|
| 2026-09-03 | grant-oci-database-service-read-access-t | Added a dedicated tenancy policy granting the OCI Database service `read secret-family` only for the generated ADB password secret by stable name. Implementation commit `4020df9`; tenancy apply and live rotation retry remain operator-owned. |
