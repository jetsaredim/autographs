...
last_activity: 2026-09-03 -- Corrected coordinated-rotation secret access to authorize the audited Vault resource principal; tenancy apply and live rotation retry remain operator-owned.
progress:
  total_phases: 10
  completed_phases: 7
  total_plans: 47
...
Last activity: 2026-09-03 -- Corrected coordinated-rotation secret access to authorize the audited Vault resource principal; tenancy apply and live rotation retry remain operator-owned.
...
| Date | Task | Summary |
|------|------|---------|
| 2026-09-03 | grant-oci-database-service-read-access-t | Added a tenancy policy granting project-compartment Vault secret resource principals `read secret-family` only for the generated ADB password secret by stable name, based on the failed request's audited caller. Corrected implementation commit `cbeed94`; tenancy apply and live rotation retry remain operator-owned. |
