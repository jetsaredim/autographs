...
| Date | Task | Summary |
|------|------|---------|
| 2026-08-14 | add-approved-production-reboot-workflow | Added a separately approved production reboot workflow that drift-checks OpenSCAP findings, reboots healthy targets, removes old installonly kernels, re-scans, and refreshes or closes the scanner issue. |
