...
- Phase 8: optional taxonomy/media thumbnail exploration for product-line and set cues first, then advisory OCR/AI metadata suggestions, while preserving manual control and text-only fallback.
