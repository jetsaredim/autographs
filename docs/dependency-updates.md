...
- Phase 8 must update this policy when OCR/AI providers, prompt tooling, model SDKs, image/text extraction dependencies, or taxonomy thumbnail/media processing dependencies are introduced.
